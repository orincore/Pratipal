    ...
    curriculum: [
      {
        ...
        description:
          "Introduction to Solfeggio frequencies, their origins, and energetic influence on the body-mind system.",
        topics: ["History of Solfeggio scale", "Frequency-emotion mapping", "Energetic hygiene basics"],
      },
      {
        title: "Applied Frequency Healing",
        description:
          "Practical frameworks to design, facilitate, and integrate sound healing sessions using tuning forks, voice, and recorded tones.",
    ...
    curriculum: [
      {
        ...
        description:
          "Understanding fertility holistically, emotional trauma release, womb nourishment, and energetic practices.",
        topics: [
          "Womb as energetic center",
          "Nutrition & self-care",
      ...
      },
      {
        ...
        description:
          "Preparing body-mind-energy for conception with Vedic rituals, herbs, subconscious reprogramming, and stress relief.",
        topics: [
          "Fertility affirmations",
          "Ovulation awareness",
          "Alkaline diet",
          "Mantras & salt rituals",
        ],
      },
    ],
    what_you_receive: [
