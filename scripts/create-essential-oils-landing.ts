/**
 * Run once to create the Essential Oils Masterclass landing page.
 * Usage: npx ts-node -r tsconfig-paths/register scripts/create-essential-oils-landing.ts
 */
...
const templateData = {
  ...
  hero: {
    ...
    subheadline: "Healing, Energy Work & Conscious Creation",
    bulletPoints: [
    ...
    points: [
      {
        ...
        description: "Use essential oils for stress, sleep, pain, digestion & emotional balance",
        icon: "🌿",
      },
      {
        title: "Safe Blending",
        description: "Create safe, effective blends using correct dilution & synergy",
        icon: "⚗️",
      },
      {
        title: "Energetic & Emotional Blends",
        description: "Design blends for grounding, confidence & heart healing",
        icon: "💚",
      },
      {
        title: "Spiritual & Ritual Use",
        description: "Learn spiritual & ritual uses of essential oils with integrity",
        icon: "🕯️",
      },
      {
        title: "Acupressure Application",
        description: "Apply oils on acupressure-inspired points for deeper results",
        icon: "✋",
      },
      {
        title: "Conscious Product Creation",
        description: "Create intention-based oils, candles, salts & signature blends",
        icon: "🌸",
      },
    ],
    ctaButtonText: "Join the Masterclass Now",
...
async function main() {
  ...
  if (existing) {
    await LandingPage.findByIdAndUpdate(existing._id, {
    ...
    console.log("✅ Updated existing landing page: /essential-oils");
  } else {
    ...
    console.log("✅ Created landing page: /essential-oils");
  }
