...
import { ArrowRight, Plus, Star, ShoppingBag, Sparkles, Heart, Leaf, Calendar } from "lucide-react";
...
function BookingSection() {
  const sessions = [
    {
      title: "One to One Healing sessions",
      description: "Frequency: Thrice a week, Twice a week, Once a week, Daily attention",
      icon: Heart,
      gradient: "from-purple-500 to-pink-500",
    },
    {
      title: "Need Based Healing",
      description: "Tarot Guidance, Emotional Freedom Technique (EFT), Reiki Energy Healing, Conceiving to grooming the womb, Acupressure treatment (with yoga recommendations), Shape the routine (24 hrs rituals : not time consuming)",
      icon: Sparkles,
      gradient: "from-blue-500 to-teal-500",
    },
    {
      title: "Spiritual Guidance and Group Healing",
      description: "Collective healing circles, intention rituals, and guided sessions to elevate energy, protect the aura, and support emotional harmony.",
      icon: Leaf,
    ...
    <section id="booking" className="py-20 md:py-28 bg-gradient-to-br from-gray-50 to-white">
      <div className="container">
          ...
          {sessions.map((session, index) => (
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <Link
                  href="/book-session"
                  className={`block text-center bg-gradient-to-r ${session.gradient} text-white px-6 py-3 rounded-full font-medium hover:shadow-xl transition-all duration-300`}
                >
                  Book Now
                </Link>
              </div>
        ...
        <div className="text-center">
          <Link
            href="/book-session"
            className="inline-flex items-center gap-2 text-brand-teal hover:text-brand-green font-medium"
          >
